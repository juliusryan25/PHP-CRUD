    ...
    <form action ="proses_edit.php" method="POST">
     <table class="table" border="0" align="center" style="width: 40%;text-align: center;margin-top: 3%;">
      <tr class="table-primary">
        <td colspan = "2"><h1>Edit Data</h1></td>
      </tr>
      <tr>  
     <td>
       <div class="form-group">
         <label for="exampleInputEmail1">Kode Produk</label>
         <input type="text"  class="form-control " id="exampleInputEmail1" value="<?php echo$key;?> " aria-describedby="emailHelp" name="kode"> 
       </div>
     </td>
 </tr>
 <tr>  
     ...
     <div class="form-group">
      <center>
        <button type='button' class='btn btn-warning'> 
         <a style="text-decoration: none;color:white" href='proses_simpan.php'>Cancel</a>
        </button>
      <Input type="submit" name="btn_submit" class="btn btn-primary" value="Edit"></Input></center>
     </div>
    </form>
  </div>
</td>
